package com.fictivestudios.demo.data.repositories
...
import com.fictivestudios.demo.data.networks.AuthApi
import com.fictivestudios.demo.data.responses.BlockUser
...
import com.fictivestudios.demo.data.responses.PatternRequest
import com.fictivestudios.demo.data.responses.RecoverUserRequest
import com.fictivestudios.demo.data.responses.ReportUser
...
class AuthRepository @Inject constructor(
    ...
    suspend fun registerPhoneNo(data: VerifyNumberRequest) = safeApiCall {
        api.registerPhoneNo(preferences.accessToken.first(), data)
    }
