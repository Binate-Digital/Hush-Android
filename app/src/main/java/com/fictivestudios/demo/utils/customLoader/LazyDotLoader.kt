package com.fictivestudios.demo.utils.customLoader
...
class LazyLoader : ThreeDotsBaseView {
    ...
    override fun initAttributes(attrs: AttributeSet) {
        ...
        this.dotsRadius = typedArray.getDimensionPixelSize(R.styleable.LazyLoader_lazyloader_dotsRadius, 5)
        ...
        this.firstDotColor = typedArray.getColor(R.styleable.LazyLoader_lazyloader_firstDotColor,
            resources.getColor(R.color.theme_red))
