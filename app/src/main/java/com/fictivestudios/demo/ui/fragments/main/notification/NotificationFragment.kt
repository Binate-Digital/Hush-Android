package com.fictivestudios.demo.ui.fragments.main.notification
...
import com.fictivestudios.demo.databinding.FragmentNotificationBinding
import com.fictivestudios.demo.ui.fragments.main.notification.itemView.RowItemNotification
...
class NotificationFragment : BaseFragment(R.layout.fragment_notification), View.OnClickListener,
        ...
        viewModel.notificationResponse.observe(viewLifecycleOwner) {
            ...
            when (it) {
                ...
                is Resource.Failure -> {
                    ...
                    if (it.message.toString() != "No posts found.") {
                        ...
                        if (it.isNetworkError) {
                            imageView?.setImageResource(R.drawable.ic_error_view)
                        } else {
